      ...
      {success === null ? (
        <View style={{ flex: 1 }}>
          ...
          >
            <View style={styles.container}>
              ...
              {customError !== "" && (
                <View
                  style={{ flexDirection: "row", marginTop: spacing, top: 3 }}
                >
                  <Feather
                    name="alert-triangle"
                    style={{ left: -8 }}
              ...
              <View style={[styles.inputContainer, styles.topInputContainer]}>
                <AntDesign
                  ...
                  size={22}
                  style={{ top: 2 }}
                  color={nameFocus ? colors.red : colors.dark}
                />
                <TextInput
                  style={styles.input}
                  ...
                  onChangeText={(text) => {
                    setName(text);
                    setError((prevState) => ({ ...prevState, nameErr: false }));
                  }}
                />
                {error.nameErr && (
                  <MaterialIcons
              ...
              <View style={styles.inputContainer}>
                <AntDesign
                  ...
                  size={22}
                  style={{ top: 2 }}
                  color={emailFocus ? colors.red : colors.dark}
                />
                <TextInput
                  style={styles.input}
              ...
              <View style={styles.inputContainer}>
                <MaterialCommunityIcons
                  ...
                  size={22}
                  style={{ top: 2 }}
                  color={passwordFocus ? colors.red : colors.dark}
                />
                <TextInput
              ...
              <View style={styles.inputContainer}>
                <MaterialCommunityIcons
                  ...
                  size={22}
                  style={{ top: 2 }}
                  color={confirmPasswordFocus ? colors.red : colors.dark}
                />
                <TextInput
                  style={[styles.input, styles.password]}
              ...
              <View style={styles.inputContainer}>
                <AntDesign
                  ...
                  color={phoneFocus ? colors.red : colors.dark}
                />
                <TextInput
                  style={styles.input}
        ...
        <View style={styles.successContainer}>
          <View style={styles.imgContainer}>
            <Image
              style={styles.img}
              source={require("../assets/account-created.jpg")}
            />
          </View>
