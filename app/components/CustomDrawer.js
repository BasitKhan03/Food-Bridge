  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={[styles.headerTitle, { fontSize: 17.5 }]}>
          Hello there!
        </Text>
      </Animated.View>
      ...
      <Animated.View style={[styles.view, styles.logout, viewStyles]}>
        ...
        >
          ...
          <View style={{ marginLeft: spacing * 1.4 }}>
            <Text
              style={{ fontSize: 14.2, color: colors.white, fontWeight: "600" }}
            >
              Logout
            </Text>
          </View>
      ...
      <Animated.View
        style={[styles.hr, viewStyles, { marginBottom: spacing * 1.3 }]}
      />
      ...
      >
        <View
          style={[
            ...
            {
              backgroundColor:
                user.imageURL === "" ? colors.light : colors.whiteSmoke,
            },
          ]}
        >
          {user.imageURL && (
