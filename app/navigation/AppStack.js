...
const DrawerNavigator = ({
  ...
  return (
    <Drawer.Navigator
      drawerContent={(props) => (
        <CustomDrawer {...props} user={user} userLevel={userLevel} />
      )}
      screenOptions={{
        headerShown: false,
        ...
        options={{
          drawerIcon: ({ color }) => (
            <AntDesign
              ...
              color={color}
              style={{
                marginLeft: spacing * 0.68,
                marginRight: spacing * 0.18,
              }}
            />
          ),
        }}
...
export default function AppStack({
  ...
  return (
    <Stack.Navigator initialRouteName="welcome">
      ...
      <Stack.Screen
        name="itemEdit"
        component={MyListingsEditScreen}
        options={{ headerShown: false }}
      />
